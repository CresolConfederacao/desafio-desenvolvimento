...
public class TaxaJurosBussiness {
	...
	public static double getTaxaJurosCalculada(double valorContrato, int quantidadeParcelas) {
	...
	public static double getValorParcelaCalculada(double valorContrato, int quantidadeParcelas, double taxaJuros) {
